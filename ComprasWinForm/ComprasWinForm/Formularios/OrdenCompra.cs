...
namespace ComprasWinForm.Formularios
{
    public partial class OrdenCompra : Form
    {
        ...
        {
            ordenCompra = new COrdenCompra(null, int.Parse(cmbSolicitud.Text), int.Parse(cmbEstado.Text));
        ...
        {
            ordenCompra = new COrdenCompra(int.Parse(txtId.Text), int.Parse(cmbSolicitud.Text), int.Parse(cmbEstado.Text));
